// components/Charts/PriorityChart.jsx
    ...
    <div className="flex flex-col sm:flex-row items-center gap-8">
      ...
      <div className="flex-1 space-y-2 w-full">
        {data.map((d, index) => (
          <div
            key={index}
            className="flex items-center justify-between text-sm text-slate-300 bg-slate-950/50 px-3 py-2 rounded-lg border border-slate-800/60"
          >
